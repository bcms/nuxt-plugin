...
import type { BCMSImageHandler, BCMSMostImageProcessorProcessOptions } from '@becomes/cms-most/types';
...
>({
  ...
  props: {
    ...
    options: {
      type: Object as PropType<BCMSMostImageProcessorProcessOptions>,
      default: undefined,
    },
    svg: {
      type: Boolean,
